...
/// </summary>
public class LightControlSpeechManager: MonoBehaviour 
{
	...
	public string grammarFileName = "LightControlSpeechGrammar.grxml";
    ...
    // The single instance of LightControlSpeechManager
    private static LightControlSpeechManager instance;


    /// <summary>
    /// Gets the single LightControlSpeechManager instance.
    /// </summary>
    /// <value>The LightControlSpeechManager instance.</value>
    public static LightControlSpeechManager Instance
    {
        get
        {
            return instance;
