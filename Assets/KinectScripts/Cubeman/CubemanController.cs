...
public class CubemanController : MonoBehaviour 
{
	...
	void Update () 
	{
        ...
        Vector3 headPosition = new Vector3(manager.GetJointPosition(userID, (int)KinectInterop.JointType.Head).x, manager.GetJointPosition(userID, (int)KinectInterop.JointType.Head).y, manager.GetJointPosition(userID, (int)KinectInterop.JointType.Head).z);
        headGO.transform.position = new Vector3(headPosition.x, headPosition.y, -headPosition.z);
        ...
        headGO.transform.rotation = rotaJoint;
